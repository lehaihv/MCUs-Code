...
lv_obj_set_style_bg_color(ui_Screen1, lv_color_hex(0x127A2C), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_opa(ui_Screen1, 255, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_Button1 = lv_btn_create(ui_Screen1);
lv_obj_set_width( ui_Button1, 256);
...
lv_obj_set_style_text_color(ui_Label1, lv_color_hex(0xDE1E1E), LV_PART_MAIN | LV_STATE_DEFAULT );
