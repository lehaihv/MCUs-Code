...
/** @file       MeInt.c
    ...
    These Functions send the given Data down to the Frame level and
    ...
    These functions perform 3 tries, afterwards a timeout is being generated.
